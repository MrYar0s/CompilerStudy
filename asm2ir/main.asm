...
calc_label_4
	...
	MODi x22 x22 400
	ADD x23 x15 x22
	GET_ELEM_PTR x23 x3 x23
	LOAD x23 x23
	ADD x37 x23 x37
	ADDi x24 x12 400
	MODi x24 x24 400
	ADD x25 x15 x24
	GET_ELEM_PTR x25 x3 x25
	LOAD x25 x25
	ADD x37 x25 x37
	ADDi x26 x12 401
	MODi x26 x26 400
	ADD x27 x15 x26
	GET_ELEM_PTR x27 x3 x27
	LOAD x27 x27
	ADD x37 x27 x37
	ADD x28 x16 x22
	GET_ELEM_PTR x28 x3 x28
	LOAD x28 x28
	ADD x37 x28 x37
	ADD x29 x16 x24
	GET_ELEM_PTR x29 x3 x29
	LOAD x29 x29
	ADD x37 x29 x37
	ADD x30 x16 x26
	GET_ELEM_PTR x30 x3 x30
	LOAD x30 x30
	ADD x37 x30 x37
	ADD x31 x17 x22
	GET_ELEM_PTR x31 x3 x31
	LOAD x31 x31
	ADD x37 x31 x37
	ADD x32 x17 x24
	GET_ELEM_PTR x32 x3 x32
	LOAD x32 x32
	ADD x37 x32 x37
	ADD x33 x17 x26
	GET_ELEM_PTR x33 x3 x33
	LOAD x33 x33
	ADD x37 x33 x37
	ICMP_EQ x34 x37 3
	ICMP_EQ x35 x37 2
